...
{
    const char* pszTimestamp = "02/10/2023 Bitfishcoin";
    const CScript genesisOutputScript = CScript() << ParseHex("0458637a2ddae47adbceaf89ee2f149f31e2920b1f8f21508364bd4654bed57b87acf30e42b422db350341055d9372d90fa656f66668f55dfb56ed162d3382a460") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Bitfishcoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Bitfishcoin: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0xd5c3dac54baf6bb096d7568b00f8ca9350966fa5df76b542a1ec00e493fbb63e"); // 0
         ...
         */
        pchMessageStart[0] = 0x62;//l
        pchMessageStart[1] = 0x74;//b
        pchMessageStart[2] = 0x73;//r
        pchMessageStart[3] = 0x63;//m
        nDefaultPort = 21002;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1676029482, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1676029482, 8571, 0x20001fff, 4, 5000 * COIN);
        ...
        vSeeds.emplace_back("seed01.bitfishcoin.org");
        vSeeds.emplace_back("seed02.bitfishcoin.org");
        vSeeds.emplace_back("seed03.bitfishcoin.org");

        // Bitfishcoin addresses start with 'L'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,26);
        // Bitfishcoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Bitfishcoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Bitfishcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Bitfishcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Bitfishcoin BIP44 coin type is '5'
...
/*         consensus.nCollaterals = SmartnodeCollaterals(
        ...
        vSporkAddresses = {"BZVtBBsxuXxyHSroDfDr67PeXKc1MUCvFV"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {0, uint256S("0xd5c3dac54baf6bb096d7568b00f8ca9350966fa5df76b542a1ec00e493fbb63e")},
        ...
        chainTxData = ChainTxData{
            1676029482,//1672502400,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Bitfishcoin: 1 day
        consensus.nPowTargetSpacing = 60; // Bitfishcoin: 1 minutes
       ...
       // FindMainNetGenesisBlock(1645942755,  0x20001fff, "test");
        ...
        //vSeeds.emplace_back("ger1.bitfishcoin.org", true);
        //vSeeds.emplace_back("ny1.bitfishcoin.org", true);

        // Testnet Bitfishcoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Bitfishcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Bitfishcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Bitfishcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Bitfishcoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Bitfishcoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Bitfishcoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("bitfishcoin.org",  "devnet-seed.bitfishcoin.org"));

        // Testnet Bitfishcoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Bitfishcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Bitfishcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Bitfishcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Bitfishcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Bitfishcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
